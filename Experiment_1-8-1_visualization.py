...
with open('results/Experiment_1-8-1_Osc_results.pickle', 'rb') as openfile:
...
with open('results/Experiment_1-8-1_Arn_results.pickle', 'rb') as openfile:
...
fig.savefig('figures/Experiment_1-8-1_Osc_metrics.png')
plt.close(fig)

fig, ax = plot_resmat_metrics(res_mat_Ar1, fwd['src'], 'Ar1')
fig.savefig('figures/Experiment_1-8-1_Ar1_metrics.png')
plt.close(fig)

fig, ax = plot_resmat_metrics(res_mat_MNE, fwd['src'], 'MNE')
fig.savefig('figures/Experiment_1-8-1_MNE_metrics.png')
plt.close(fig)
