...
with open('results/Experiment_1-10_Osc_results.pickle', 'rb') as openfile:
...
with open('results/Experiment_1-10_Arn_results.pickle', 'rb') as openfile:
...
fig.savefig('figures/Experiment_1-10_Osc_metrics.png')
plt.close(fig)

fig, ax = plot_resmat_metrics(res_mat_Ar1, fwd['src'], 'Ar1')
fig.savefig('figures/Experiment_1-10_Ar1_metrics.png')
plt.close(fig)

fig, ax = plot_resmat_metrics(res_mat_MNE, fwd['src'], 'MNE')
fig.savefig('figures/Experiment_1-10_MNE_metrics.png')
plt.close(fig)
